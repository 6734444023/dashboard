            ...
            [
                ...
                dbc.Col(
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                "Q1 – การวินิจฉัยโรคหลัก (Primary Diagnosis) ส่งผลต่อการเข้าใช้เตียงผู้ป่วยจริงหรือไม่?",
    ...
    takeaways = html.Div(
        [
            _block(
                ...
                f"การวินิจฉัยโรคส่งผลต่อ LOS ชัดเจน: avg {top_diag_avg:.1f}d (สูงสุด) → {bot_diag_avg:.1f}d (ต่ำสุด)",
                "วางแผน Discharge Planning ล่วงหน้าสำหรับกลุ่มโรคที่มี avg LOS สูง",
            ),
            _block(
                "Q2 – MICU vs SICU",
                "MICU: โรคติดเชื้อ/ไตวาย  |  SICU: ภาวะเลือดออกในสมอง",
                "กำหนด Protocol รับ-ส่งเคสตามประเภทโรคเพื่อลดการใช้เตียงผิดประเภท",
            ),
            _block(
                "Q3 – LOS Variation",
                f"{pct_under7:.0f}% อยู่ ≤7 วัน  |  {pct_over30:.1f}% อยู่ >30 วัน (Outlier ~70 วัน)",
                "ใช้ Early-Warning Score คัดกรองเคสเสี่ยงยืดเยื้อตั้งแต่วันแรก",
            ),
        ]
    )
